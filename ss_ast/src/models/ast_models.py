...
class ASTModel(nn.Module):
    def __init__(self, label_dim=10,
        ...
        if pretrain_stage == True:
            ...
            print('pretraining patclabel_dimh split stride: frequency={:d}, time={:d}'.format(fstride, tstride))
        ...
        # use a pretrained models for finetuning
            ...
            print('the fdim and tdim are given here',p_input_fdim, p_input_tdim)
            ...
            if fstride != p_fshape or tstride != p_tshape:
                # initialize a new patch embedding layer wlabelith desired new stride.
                new_proj = torch.nn.Conv2d(1, self.original_embedding_dim, kernel_size=(fshape, tshape), stride=(fstride, tstride))
