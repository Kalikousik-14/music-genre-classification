...
te_data=data/val.json
ev_data=data/test.json
...
pre_tr_path=./pretrained_model/SSAST-Tiny-Patch-400.pth
...
--task ${task} --lr_patience ${lr_patience} --epoch_iter 800 --data-eval ${ev_data} \
--pretrained_mdl_path ${pre_tr_path}